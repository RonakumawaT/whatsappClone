...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new messagesAdapter(this, messages, receiverUid, senderRoom, receiverRoom);
        ...
        binding.sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Date date = new Date();
                msgModel message = new msgModel(senderUid, messageTxt, date.getTime());
        ...
        try {
            ...
            JsonObjectRequest request = new JsonObjectRequest(url, notificationData
                ...
                public Map<String, String> getHeaders() throws AuthFailureError {
                    ...
                    String key = "Key=AAAATu-_uOM:APA91bH7EEsYjjd-tQvLNnIT3NSXKkD0vLS5HUyxZEZ4TiJByLUUSRTWQ69VsLep9ddUMiIRWcVTBPikhpz6c-WAEPQZ4qAGsCJ1UAZZ3vab-QCdVNXa4klfvz86hJcrIWz9CjPVTU3o";
